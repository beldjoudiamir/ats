...
import AddCommi from "./addCommissionnaire";
...
const SearchForm = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between bg-gray-200 dark:bg-gray-700 rounded-lg mt-2 p-2 gap-2 sm:gap-4 w-full">
      ...
      {/* Bouton Ajouter Commissionnaire */}
      <button 
      ...
      {/* Affichage du composant AddCommi si isOpen est true */}
      {isOpen && <AddCommi onClose={() => setIsOpen(false)} />}
    </div>
  );
};
