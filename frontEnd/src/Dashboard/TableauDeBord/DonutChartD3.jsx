...
export default function DonutChartD3({ data }) {
  const ref = useRef();
  ...
  useEffect(() => {
    ...
    const arcOver = d3.arc().innerRadius(0).outerRadius(radius + 10);

    // Animation d'apparition + effet hover
    svg.selectAll("path")
      .data(data_ready)
      .enter()
      .append("path")
  ...
  return (
    <div className="flex flex-col items-center">
      <svg ref={ref} style={{ maxWidth: 340, width: "100%", height: 220 }}></svg>
